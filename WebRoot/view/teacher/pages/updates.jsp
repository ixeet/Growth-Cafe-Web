										  ...
										  <li class="comment-form">
											<div class="media-left">
												   <s:if test="#session.teacherloginDetail.profilePhotoFileName !=null && #session.teacherloginDetail.profilePhotoFileName !=''">
													   <a href="javaScript:;" onclick="personalProfile(${teacherloginDetail.userId});" class=""><img src="${sessionScope.teacherloginDetail.profilePhotoFileName}" class="media-object  width-20"></i></a>
													   </s:if>
													   <s:else>
													   	<a href="javaScript:;" onclick="personalProfile(${teacherloginDetail.userId});" class=""><img src="view/helper/images/people/50/guy-6.jpg" class="media-object  width-20"></i></a>
													   </s:else>
												</div>
												<div class="media-body">
										  ...
										  <li class="comment-form">
											<div class="media-left">
													<a href="javaScript:;" onclick="personalProfile(${teacherloginDetail.userId});" class="">
													   <s:if test="#session.teacherloginDetail.profilePhotoFileName !=null && #session.teacherloginDetail.profilePhotoFileName !=''">
														   <img src="${sessionScope.teacherloginDetail.profilePhotoFileName}" class="media-object  width-20">
														   </s:if>
														   <s:else>
														   	<img src="view/helper/images/people/50/guy-6.jpg" class="media-object width-20">
														   </s:else>
                    ...
                    <div class="panel panel-default" data-toggle="panel-collapse" data-open="true">
                        ...
                        <div class="panel-body list-group pad_0">
                           ...
                           <s:if test="#session.courseReportList != null && #session.courseReportList.size()>3">
                                ...
                                <s:if test="#session.courseReportList.size()>0">
									<li class="list-group-item paper-shadow">
                                        <div class="media v-middle">
												<a class="btn-pad normalbutton btn-height margin_bot1" href="javaScript:;" onclick="showCourse();" >View All</a>
                                        </div>
                                    </li>
							</s:if>
							<s:else>
                        ...
                        <div class="panel-body list-group pad_0">
                           <ul class="list-group relative paper-shadow" data-hover-z="0.5" data-animated>
                           		...
                           		<s:iterator value="#session.assignmentReportList" begin="0" end="2">
                                    ...
                                    <s:if test="#session.assignmentReportList.size()>0">
									<li class="list-group-item paper-shadow">
                                        <div class="media v-middle">
												<a class="btn-pad normalbutton btn-height" href="javaScript:;" onclick="assignments();" >View All</a>
                                        </div>
                                    </li>
                                    </s:if>
                                    <s:else>
